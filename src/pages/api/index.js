...
export default async function handler(req, res) {
  ...
  try {
    switch (
      req.method // CRUD operations (aka Create, Remove, Update, Delete)
    ) {
      case "GET":
        const readData = await fetch(`${baseUrl}/find`, {
          //e fetch to make a request to the find Data API endpoint using the baseUrl, fetchOptions, and fetchBody variables.
          ...
          body: JSON.stringify({
            //make a string out of the request body
            ...fetchBody,
